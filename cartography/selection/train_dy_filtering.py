...
def compute_train_dy_metrics(training_dynamics, args):
    ...
    df_train = pd.DataFrame([[i,
                              ...
                              ] for i in range(num_tot_epochs)], columns=['epoch', 'loss', 'train_acc'])
    return df, df_train
...
if __name__ == "__main__":
    ...
    parser.add_argument("--worst",
                        action="store_true",
                        help="Select from the opposite end of the spectrum acc. to metric, for baselines")
